...
.config(['GlobalizationPipelineServiceProvider', function(GlobalizationPipelineServiceProvider) {
    ...
    GlobalizationPipelineServiceProvider.setGpConfig({
        ...
        loadingText: "loading...",
        credentials: {
            uri: "https://gp-dev-rest.stage1.ng.bluemix.net/translate",
            instanceId: "eb50c0fdc89e4c3c3d8b653fa16647d0",
            userId: "809d326d376cd4367af85c9523606c90",
            password: "iMGHXLG/Qz/p/ioOkaverpaJ2LRHDcsA"
        }});
}])
